...
train_data=[];
train_data=convertGrayScale("C:/Users/admin/Downloads/fruit-quality-detection-master/fruit-quality-detection-master/data set/*.jpg");
...
def get() :
    ...
    imageName=arr[0];
    print(imageName);
    with open(r"C:\Users\admin\Downloads\fruit-quality-detection-master\fruit-quality-detection-master/test_data/"+imageName, "rb") as f:
        data = f.read()
...
def five() :
    ...
    for x in ll:
        arr = x.split(' ');
        imageName=arr[0];
        with open("C:/Users/admin/Downloads/fruit-quality-detection-master/fruit-quality-detection-master/test_data/"+imageName, "rb") as f:
            data = f.read()
            encodingData=data.encode("base64")
...
def sendimage() :
    with open("C:/Users/admin/Downloads/fruit-quality-detection-master/fruit-quality-detection-master/test_data/image_0.jpg", "rb") as f:
        data = f.read()
        encodingData=data.encode("base64")
        print(encodingData)
